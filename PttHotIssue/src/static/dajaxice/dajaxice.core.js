...
var Dajaxice = {
    ...
    HotIssue: {
    	...
    	dajaxice_relatived: function(callback_function, argv, custom_settings){
            Dajaxice.call('HotIssue.dajaxice_relatived', 'POST', callback_function, argv, custom_settings);
        },
